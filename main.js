...
var polizei = ["Achtung, muck nicht. Ich bin Polizei."
,"Fahr mit Limousine bei Dir zu Haus vorbei."
,"Stehenbleiben, Beine breit, Ausweis dabei?"
,"Hast du was dagegen? Ruf doch Polizei!"
,"Ich geh auf Streife, Du wechselst Straßenseite."
,"Schlägst du mich kaputt, komm' fünfundzwanzig neue."
,"Muskelottos fuchteln mit Butterflys und freun' sich, doch ich bin Polizei ich hab P99."
,"Ich fahr mit Sonderrecht bei rot über Ampel."
,"Du bist Räuber und guck mal ich bin Gendarm."
,"Du willst Gesetze brechen? Zieh mal lieber Leine. Denn ich bin Polizei mein Schatz, weisst schon was ich meine."
,"Du hast gut trainiert? Ich bin Polizei."
,"Du hast Deine Maschtis? Ich bin Polizei."
,"Hab mal nicht so große Fresse. Ich bin Polizei."
,"Guck mal meine Mütze"
,"Ich bin Polizei."
...
,"Polizei hat Maschinengewehre, Nachtsichtgeräte, Wasserwerfer, Helikopter und für Blutentnahme, hat Polizei sogar ein Doktor."
...
,"Ich bin Polizei: beste Schlägertruppe."
...
,"BePo aus Bayern, BePo aus Sachsen, kommen im VW-Bus, brechen Dir Beppo die Haxen."
...
client.on('message', function (event) {
    if (event.message.match(/polizei/gi)) event.reply(polizei[Math.floor(Math.random() * polizei.length)])
});

client.on('command', function (event) {
  switch (event.cmd) {
    case 'polizei':
     // event.reply(polizei[Math.floor(Math.random() * polizei.length)])
      break
    case 'song':
    case 'sing':
      event.reply("https://www.youtube.com/watch?v=PNjG22Gbo6U")
      break
  }
});
